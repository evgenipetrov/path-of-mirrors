...
1. Review [ARCHITECTURE_DIAGRAM.md](ARCHITECTURE_DIAGRAM.md) for visual overview
1. Check [CONTRIBUTING.md](CONTRIBUTING.md) for coding standards

### For Product Managers

1. [PRODUCT.md](PRODUCT.md) - Vision and features
1. [SPRINT.md](SPRINT.md) - Current progress
1. [BACKLOG.md](BACKLOG.md) - Roadmap and priorities
1. [EPIC_SEQUENCE.md](EPIC_SEQUENCE.md) - Release planning

### For DevOps/SREs

1. [INFRASTRUCTURE_SETUP.md](INFRASTRUCTURE_SETUP.md)
1. [MIGRATION_TEST_PLAN.md](MIGRATION_TEST_PLAN.md)
1. [ARCHITECTURE.md](ARCHITECTURE.md) - Section 7 (Deployment)

### For Architects

1. [ARCHITECTURE.md](ARCHITECTURE.md) - Complete reference
1. [ARCHITECTURE_DIAGRAM.md](ARCHITECTURE_DIAGRAM.md) - Visual diagrams
1. [adr/](adr/) - Architecture decisions
1. [CONTRIBUTING.md](CONTRIBUTING.md) - Coding patterns
